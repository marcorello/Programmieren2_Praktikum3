...
namespace {
struct qt_meta_tag_ZN14TravelAgencyUIE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN14TravelAgencyUIE = QtMocHelpers::stringData(
    "TravelAgencyUI",
    "loadBookings",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14TravelAgencyUIE[] = {
...
Q_CONSTINIT const QMetaObject TravelAgencyUI::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14TravelAgencyUIE.offsetsAndSizes,
    qt_meta_data_ZN14TravelAgencyUIE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14TravelAgencyUIE_t,
        // Q_OBJECT / Q_GADGET
...
void *TravelAgencyUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14TravelAgencyUIE.stringdata0))
